...
Long term however, this pattern probably isn't that helpful. Hooks basically elimate the need for class components, and in functional components you can use them directly.
